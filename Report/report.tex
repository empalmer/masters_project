...
\begin{abstract}
  ...
  Using datasets beyond the case study provided in the initial paper, which are larger and include incomplete taxonomic labels not pre-organized into a taxonomic hierarchy, required code to be developed and workflows defined for intermediate steps. Datasets that include more than a small subset of OTUs run into computational limitations using this model.
...
% make this transition better - explain why taxonomic trees
% define/explain association studies
...
\subsection{Correlations for OTUs without full taxonomic levels}
...
Several attempts were made to filter the American Gut project data based on biological motivations. Even these attempts resulted in either correlation matrices too large to even initialize, issues with running out of computer memory, or computation times that lasted several days without completion.
