...
Continue what i'm doing now, implement on real data



Find phylogenetic information for all in twin structure

Compositional nature of data? not included?





Sequencing depth - can be different across data 


**** Use a model on count data directly.
